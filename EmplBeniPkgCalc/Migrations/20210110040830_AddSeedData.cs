        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 1, false, 1, "Wednesday", "Addams", new DateTime(2007, 5, 3, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, false, 1, "Pugsley", "Addams", new DateTime(2009, 7, 29, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, false, 1, "Grandmama", "Addams", new DateTime(1942, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, true, 2, "Helen", "Parr", new DateTime(1980, 2, 25, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, false, 2, "Violet", "Parr", new DateTime(2005, 9, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, false, 2, "Dash", "Parr", new DateTime(2011, 4, 30, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, false, 2, "Jack-Jack", "Parr", new DateTime(2019, 11, 4, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, false, 5, "John", "Connor", new DateTime(2006, 5, 14, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, true, 6, "Iduna", "Runeardsson", new DateTime(1977, 3, 31, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, false, 6, "Elsa", "Runeardsson", new DateTime(2010, 12, 12, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 1, false, 6, "Anna", "Runeardsson", new DateTime(2013, 6, 8, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                });
